...
namespace Axcel\Halo\Eloquent\Database\Builder;

use Axcel\Halo\Eloquent\Database\Builder\Traits\CompileFirst;
use Axcel\Halo\Eloquent\Database\Builder\Traits\Compiler;
use Axcel\Halo\Eloquent\Database\Builder\Traits\CompileWheres;
use Axcel\Halo\Eloquent\Database\Builder\Traits\Counting;
use Axcel\Halo\Eloquent\Database\Builder\Traits\Orders;
use Axcel\Halo\Eloquent\Foundations\Model;
use Axcel\Halo\Eloquent\Database\ConnectionManager;
...
class Builder
{
     ...
     *
     * @var \Axcel\Halo\Eloquent\Foundations\Model
     */
    protected $model;
     ...
     *
     * @param \Axcel\Halo\Eloquent\Foundations\Model $model
     * @return $this
     */
     ...
     * @param mixed $id
     * @param array $columns
     * @return \Axcel\Halo\Eloquent\Foundations\Model|null
     */
     ...
     * @param mixed $id
     * @param array $columns
     * @return \Axcel\Halo\Eloquent\Foundations\Model
     * @throws \Exception
     */
     ...
     *
     * @param array $columns
     * @return \Axcel\Halo\Eloquent\Foundations\Collection
     */
        ...
        foreach ($this->getEagerLoad() as $relation) {
            $models->each(function ($model) use ($relation) {
                if (method_exists($model, $relation)) {
                    ...
                    if ($relationQuery instanceof \Axcel\Halo\Eloquent\Database\Builder\Builder) {
